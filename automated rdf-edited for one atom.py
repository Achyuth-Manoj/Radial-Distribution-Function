...
os.chdir("/Users/Achyuth Manoj/ResearchData_MLProject/Pu")
for filename in os.listdir():
    if filename.endswith("vasp"):
        ...
        coordinates_lesser=coordinates_atom1_lesser
        ...
        coordinates_greater=coordinates_atom1_greater
        ...
        filename_1="".join((filename,"_coordinates_lesser.txt"))
        filename_2="".join((filename,"_coordinates_greater.txt"))
        f=open(filename_1,"w")
        ...
        print(result)
        filename_3="".join((filename,"_rdf.txt"))
        f=open(filename_3,"w")
